...
const SubHeader = () => {
  return (
    <div>
      <header className="">
        <div className="  bg-[white] border-b h-[80px] border-[#22222212] flex  items-center justify-evenly">
          <div>
          ...
          <div>
            <div className=" v flex  items-center  justify-evenly font-medium text-[black] w-[33%]">
              ...
              <button className=" connect  text-[#fc72ff] pr-[10px] pl-[10px]  rounded-full">
                Connect
              </button>
            </div>
          </div>
